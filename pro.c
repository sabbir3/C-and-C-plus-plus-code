...
void main()
{
  ...
  char point4[15];
   ...
   printf("\n                                                    ==                                 ==");
   printf("\n                                                    =====================================\n\n\n\n");
   printf("                                    \t\t===STUDENTS  RESULT  MANAGEMENT  SYSTEM====\n");
...
for(i=1;i<=student;i++)
  ...
  Average=(total*100) / x;
    ...
    //printf("your CGPA :: %d" ,v);


      if(cse<40||english<40||math<40||cselab<40||softwarelab<40){
        KK=1;
      }
 ...
 // scanf("%s",&season);
    ...
    printf("  Student Batch  : %d%s\n",batch,batch_th);

    printf("  Student Semester : %d%s\n",semester);

    printf("  Student Section : %s\n\n",sec);


    printf("                   ||---------------------------------||\n                   ||---------------------------------||");
    printf("  \n\t           ||   STUDENTS RESULT DATA TABLE    ||\n");
    ...
    printf("  |Subject  |       Max  |   Min   |      Marks   |    Grade   |   Point  | Total  | Average |\n");

    printf("  |---------|------------|---------|--------------|------------|----------|        |------------|\n");

    printf("  |CSE      |       100  |   36    |      %d      |    %s      |   %s\n",cse,mark,point);

    printf("  |---------|------------|---------|--------------|------------|----------|        |            |\n");

    printf("  |Math     |       100  |   36    |      %d      |    %s      |   %s\n" ,math,mark1,point1);

    printf("  |---------|------------|---------|--------------|------------|----------|        |            |\n");

    printf("  |English  |       100  |   36    |      %d      |    %s      |   %s\n",english,mark2,point2);
    ...
    printf("  |Cselab   |       100  |   36    |      %d      |   %s       |    %s\n",cselab,mark3,point3);

    printf("  |---------|------------|---------|--------------|------------|----------|        |            |\n");

    printf(" softwarelab|       100  |   36    |      %d      |    %s      |    %s\n",  softwarelab,mark4,point4);
    ...
    if(KK==1)
    {
    printf("  This student is fall and his grade is  F");
    break;
    }

    fprintf(fp,"  Subject          Max     Min         Marks       Grade      Point     \n");

    fprintf(fp,"------------------------------------------------------------------------\n");

    fprintf(fp,"  CSE              100     36         %d           %s        %s\n",cse,mark,point);

    fprintf(fp,"  Math             100     36         %d           %s        %s\n",math,mark1,point1);

    printf(fp,"  English            100    36         %d           %s      %s\n",english,mark2,point2);

    fprintf(fp,"  cselab           100     36         %d           %s       %s\n",cselab,mark3,point3);

    fprintf(fp,"  softwarelab      100     36         %d           %s       %s\n",softwarelab,mark4,point4);
